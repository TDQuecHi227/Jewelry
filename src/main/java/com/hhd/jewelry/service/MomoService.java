...
public class MomoService {
    ...
    public String createMomoPayment(long order_Id, long amount, String orderInfo, HttpServletRequest request) throws Exception {
        ...
        String returnUrl = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + MomoConfig.VNP_RETURN_URL;
        String ipnUrl = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + MomoConfig.VNP_IPN_URL;
        ...
        HttpURLConnection con = (HttpURLConnection) new URL(MomoConfig.VNP_PAYMENT_URL).openConnection();
